...
@Component({
  ...
  `,
  styles: [`
    :host{display:block}.formats-shell{max-width:1220px;margin:0 auto}.formats-head{display:flex;align-items:flex-end;justify-content:space-between;gap:28px}.formats-head>div:first-child{max-width:820px}.formats-head h1{margin:0;font-size:45px;letter-spacing:-.05em;line-height:1.03}.formats-head p:last-child{margin:10px 0 0;color:var(--text-muted);font-size:12px;line-height:1.6}.catalog-stat{min-width:112px;padding:12px;border:1px solid var(--border);border-radius:12px;background:var(--surface-1);text-align:center}.catalog-stat strong,.catalog-stat span{display:block}.catalog-stat strong{font-size:24px}.catalog-stat span{color:var(--text-faint);font-size:9px}.format-toolbar{display:grid;grid-template-columns:minmax(260px,1fr) 190px auto;gap:8px;align-items:center;margin:23px 0 10px;padding:9px}.format-toolbar>label:first-child{display:grid;grid-template-columns:22px 1fr;align-items:center;padding:0 8px}.format-toolbar input[type=search],.format-toolbar select{height:34px;border:0;background:transparent;color:var(--text);outline:0;font:inherit;font-size:11px}.format-toolbar select{padding:0 8px;border-left:1px solid var(--border)}.ready-only{display:flex;align-items:center;gap:6px;color:var(--text-muted);font-size:9px}.format-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.format-card{padding:14px;min-width:0}.format-card>header{display:grid;grid-template-columns:42px minmax(0,1fr) auto;align-items:center;gap:9px}.format-mark{width:40px;height:40px;display:grid;place-items:center;border-radius:10px;background:var(--accent-soft);color:var(--accent);font-size:9px;font-weight:900}.format-card header strong,.format-card header span{display:block}.format-card header strong{font-size:13px}.format-card header span{margin-top:2px;color:var(--text-muted);font-size:9px}.format-card header>b{color:var(--text-faint);font-size:8px}.extensions,.technical-tags{display:flex;flex-wrap:wrap;gap:4px;margin-top:10px}.extensions code,.format-card footer code{padding:3px 5px;border-radius:5px;background:var(--surface-2);color:var(--text-muted);font-size:8px}.capability-row{display:flex;flex-wrap:wrap;gap:4px;margin-top:9px}.capability-row span{padding:4px 6px;border-radius:6px;background:var(--surface-2);color:var(--text-faint);font-size:8px}.capability-row span.on{background:var(--success-soft);color:var(--success)}.technical-tags span{font-size:8px;color:var(--accent);padding:3px 5px;border:1px solid color-mix(in srgb,var(--accent) 20%,var(--border));border-radius:999px}.action-list{margin-top:12px;border-top:1px solid var(--border);padding-top:10px}.subhead{display:flex;justify-content:space-between;align-items:center;margin-bottom:5px}.subhead strong{font-size:9px;text-transform:uppercase;letter-spacing:.06em}.subhead span{color:var(--text-faint);font-size:8px}.action-list button{width:100%;display:grid;grid-template-columns:1fr auto;gap:10px;align-items:center;padding:7px 5px;border:0;border-bottom:1px solid var(--border);background:transparent;color:var(--text);text-align:left}.action-list button:hover{background:var(--surface-2)}.action-list button strong,.action-list button small{display:block}.action-list button strong{font-size:9px}.action-list button small{margin-top:2px;color:var(--text-faint);font-size:8px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.action-list button>span{color:var(--accent);font-size:8px;font-weight:800}.action-list button.not-ready{opacity:.6}.action-list button.not-ready>span{color:var(--warning)}.no-actions{color:var(--text-faint);font-size:9px}.format-card>footer{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:10px}.format-card footer>div{padding:8px;border-radius:8px;background:var(--surface-2)}.format-card footer span{display:block;color:var(--text-faint);font-size:8px;font-weight:800;text-transform:uppercase}.format-card footer p{display:flex;flex-wrap:wrap;gap:3px;margin:5px 0 0}.empty{grid-column:1/-1;min-height:200px;display:grid;place-items:center;align-content:center;text-align:center}.empty span{margin-top:5px;color:var(--text-muted);font-size:10px}@media(max-width:850px){.format-grid{grid-template-columns:1fr}.formats-head h1{font-size:38px}.format-toolbar{grid-template-columns:1fr 150px}.ready-only{grid-column:1/-1}}@media(max-width:560px){.formats-head{display:block}.catalog-stat{margin-top:10px;width:max-content}.formats-head h1{font-size:32px}.format-toolbar{grid-template-columns:1fr}.format-toolbar select{border-left:0;border-top:1px solid var(--border)}.format-card>footer{grid-template-columns:1fr}}
  `],

...
const ESSENTIAL_GUIDES: HelpGuide[] = [
  ...
  { id:'html-pdf', title:'Créer un PDF depuis une page HTML', summary:'Rendre aussi les contenus créés par JavaScript.', keywords:'html htm javascript script web page pdf navigateur', actionId:'html-to-pdf', steps:['Ajoutez le fichier HTML depuis « PDF & documents ».','Choisissez PDF comme résultat.','FileFlow exécute brièvement le rendu local, sans accès réseau.','Vérifiez l’aperçu puis créez le PDF dans la destination affichée.'] },
  { id:'email-pdf', title:'Archiver un e-mail EML en PDF', summary:'Conserver les en-têtes et le message sans exécuter ses scripts.', keywords:'eml mail email courrier html script pdf archive', actionId:'email-to-pdf', steps:['Ajoutez le fichier EML.','Choisissez PDF comme résultat.','FileFlow décode le message et neutralise ses contenus actifs.','Ouvrez le PDF lisible : les pièces jointes restent dans l’EML original.'] },

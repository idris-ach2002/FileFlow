...
@Component({
  ...
  template: `
    <div class="ff-page simple-home">
      ...
      <section class="home-card" aria-labelledby="home-drop-title">
        ...
        <div class="guidance-note"><span>✦</span><strong>Le plus simple&nbsp;:</strong> commencez par votre fichier.</div>
      </section>

      <aside class="home-trust">
        <div><span>◆</span><strong>Traitement local</strong><small>Vos fichiers restent sur cet appareil.</small></div>
  ...
  `,
  styles: [`
    :host{display:block}.simple-home{max-width:1120px;margin:0 auto;padding-top:22px}.home-heading{max-width:820px}.eyebrow{margin:0 0 16px;color:var(--text);font-size:13px;font-weight:820;letter-spacing:.04em}.home-heading h1{margin:0;font-size:clamp(46px,6.2vw,78px);line-height:.98;letter-spacing:-.065em;font-weight:850}.lead{max-width:720px;margin:20px 0 0;color:var(--text-muted);font-size:17px;line-height:1.6}.home-card{margin-top:38px;padding:22px;border:1px solid var(--border);border-radius:28px;background:var(--surface-1);box-shadow:var(--shadow-sm)}.step-badge{display:flex;align-items:center;gap:10px;margin-bottom:18px}.step-badge span{width:30px;height:30px;display:grid;place-items:center;border-radius:50%;background:var(--accent-soft);color:var(--accent);font-weight:900}.step-badge strong{font-size:17px}.drop-zone{min-height:310px;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:34px;border:1.5px dashed color-mix(in srgb,var(--accent) 32%,var(--border-strong));border-radius:22px;background:linear-gradient(145deg,var(--surface-1),color-mix(in srgb,var(--accent-soft) 32%,var(--surface-1)));text-align:center;transition:var(--transition)}.drop-zone:hover{border-color:color-mix(in srgb,var(--accent) 68%,var(--border));box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--accent) 8%,transparent)}.upload-icon{position:relative;width:78px;height:62px;margin-bottom:14px;color:var(--accent)}.cloud{font-size:58px;line-height:1}.arrow{position:absolute;left:50%;bottom:1px;transform:translateX(-50%);width:28px;height:28px;display:grid;place-items:center;border-radius:50%;background:var(--surface-1);font-size:24px;font-weight:900}.drop-zone h2{margin:0;font-size:20px;letter-spacing:-.03em}.drop-zone>p,.or{margin-top:8px;color:var(--text-muted);font-size:13px}.primary-choice{min-width:230px;min-height:52px;display:flex;align-items:center;justify-content:center;gap:10px;margin-top:12px;border:0;border-radius:12px;background:linear-gradient(135deg,var(--accent),var(--violet));color:white;font-size:16px;font-weight:800;box-shadow:0 13px 28px color-mix(in srgb,var(--accent) 22%,transparent);transition:var(--transition)}.primary-choice:hover{transform:translateY(-1px);box-shadow:0 16px 34px color-mix(in srgb,var(--accent) 27%,transparent)}.folder-icon{font-size:20px}.folder-choice{margin-top:10px;border:0;background:transparent;color:var(--text-muted);font-size:13px;font-weight:700}.folder-choice:hover{color:var(--accent)}.quick-label{margin:20px 2px 10px;color:var(--text-muted);font-size:12px;font-weight:760}.quick-categories{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.quick-categories button{min-height:92px;display:grid;place-items:center;align-content:center;gap:8px;border:1px solid var(--border);border-radius:16px;background:var(--surface-2);color:var(--text);transition:var(--transition)}.quick-categories button:hover{transform:translateY(-2px);border-color:var(--border-strong);background:var(--surface-1);box-shadow:var(--shadow-sm)}.quick-categories strong{font-size:12px}.cat-icon{width:38px;height:38px;display:grid;place-items:center;border-radius:11px;font-size:16px;font-weight:900}.cat-icon.pdf{background:var(--danger-soft);color:var(--danger)}.cat-icon.image{background:var(--success-soft);color:var(--success)}.cat-icon.video{background:var(--accent-soft);color:var(--accent)}.cat-icon.archive{background:var(--warning-soft);color:var(--warning)}.guidance-note{margin-top:16px;padding:13px 15px;border-radius:14px;background:var(--accent-soft);color:var(--text-muted);font-size:12px}.guidance-note span{margin-right:7px;color:var(--accent)}.guidance-note strong{color:var(--accent-strong)}.home-trust{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:14px}.home-trust>div,.home-trust>button{min-height:70px;display:grid;grid-template-columns:34px 1fr auto;align-items:center;gap:9px;padding:12px 15px;border:1px solid var(--border);border-radius:17px;background:var(--surface-1);color:var(--text);text-align:left}.home-trust>div{grid-template-columns:34px 1fr}.home-trust>span,.home-trust button>span{color:var(--success)}.home-trust strong,.home-trust small{display:block}.home-trust strong{font-size:13px}.home-trust small{margin-top:2px;color:var(--text-muted);font-size:11px}.home-trust button{cursor:pointer}.home-trust button>span{color:var(--accent)}.home-trust button>b{color:var(--accent);font-size:20px}.pulse{animation:pulse 1s infinite alternate}@keyframes pulse{to{opacity:.45;transform:scale(.97)}}@media(max-width:760px){.simple-home{padding-top:8px}.home-heading h1{font-size:44px}.lead{font-size:15px}.home-card{margin-top:26px;padding:15px}.drop-zone{min-height:270px}.quick-categories{grid-template-columns:repeat(2,1fr)}.home-trust{grid-template-columns:1fr}}
  `],

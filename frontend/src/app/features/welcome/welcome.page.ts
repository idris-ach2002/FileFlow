...
@Component({
    ...
    <main class="welcome-shell">
      <section class="welcome-card">
        <header class="welcome-brand">
          <div class="logo"><img src="/fileflow-emblem.png" alt="" /></div>
      ...
      <aside class="welcome-aside">
        <section class="brand-stage">
          <span class="local-pill"><i></i> TRAITEMENT LOCAL</span>
          <img src="/fileflow-emblem.png" alt="Emblème FileFlow" />
          <p class="brand-kicker">FILEFLOW FOR BUSINESS</p>
          <h2>Un flux clair.<br />Aucun fichier envoyé.</h2>
          <p>Conversion, aperçu et organisation restent sur cet appareil, avec une interface pensée pour aller droit au résultat.</p>
          <div class="brand-facts"><span>HTML + JS</span><span>EML</span><span>HEIC</span><span>PDF</span></div>
        </section>
      </aside>
    </main>
  `,
  styles: [`
    ...
    .welcome-brand{display:flex;align-items:center;gap:12px}.logo{width:48px;height:48px;display:grid;place-items:center;overflow:hidden;border-radius:15px;background:#07162e;box-shadow:0 10px 26px color-mix(in srgb,var(--accent) 25%,transparent)}.logo img{width:100%;height:100%;object-fit:cover}.welcome-brand strong,.welcome-brand span{display:block}.welcome-brand strong{font-size:19px}.welcome-brand span{margin-top:2px;color:var(--text-faint);font-size:11px;font-weight:850;letter-spacing:.08em;text-transform:uppercase}
    ...
    .welcome-aside{align-self:stretch;display:flex;align-items:center}.brand-stage{position:relative;min-height:650px;width:100%;display:flex;flex-direction:column;align-items:flex-start;justify-content:flex-end;overflow:hidden;padding:30px;border:1px solid rgb(255 255 255 / 13%);border-radius:34px;background:radial-gradient(circle at 50% 25%,#123e70 0,#071b38 36%,#061226 72%);color:#fff;box-shadow:0 36px 100px rgb(5 16 37 / 28%)}.brand-stage:before{content:'';position:absolute;inset:-25%;background:conic-gradient(from 180deg,transparent,#24c7ee22,transparent,#58dfaa1b,transparent);animation:auroraTurn 14s linear infinite}.brand-stage>img{position:absolute;z-index:1;top:72px;left:50%;width:min(84%,330px);transform:translateX(-50%);border-radius:29%;filter:drop-shadow(0 25px 45px rgb(24 186 235 / 25%));animation:emblemFloat 4.8s ease-in-out infinite}.local-pill,.brand-stage h2,.brand-stage p,.brand-facts{position:relative;z-index:2}.local-pill{position:absolute;top:24px;left:24px;display:flex;align-items:center;gap:8px;padding:8px 11px;border:1px solid rgb(255 255 255 / 13%);border-radius:999px;background:rgb(7 23 49 / 55%);font-size:10px;font-weight:850;letter-spacing:.11em;backdrop-filter:blur(12px)}.local-pill i{width:8px;height:8px;border-radius:50%;background:#59e3a8;box-shadow:0 0 0 5px rgb(89 227 168 / 10%)}.brand-kicker{margin:0 0 9px;color:#7ee9ff!important;font-size:10px!important;font-weight:850;letter-spacing:.14em}.brand-stage h2{margin:0;color:#fff;font-size:34px;line-height:1.03;letter-spacing:-.05em}.brand-stage>p:not(.brand-kicker){margin:14px 0 18px;color:#aebed7;font-size:13px;line-height:1.58}.brand-facts{display:flex;flex-wrap:wrap;gap:7px}.brand-facts span{padding:7px 9px;border:1px solid rgb(255 255 255 / 11%);border-radius:10px;background:rgb(255 255 255 / 6%);color:#d9edff;font-size:10px;font-weight:800}@keyframes emblemFloat{50%{transform:translate(-50%,-9px) scale(1.015)}}@keyframes auroraTurn{to{transform:rotate(1turn)}}
